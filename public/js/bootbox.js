...
window.bootbox = window.bootbox || (function init($, undefined) {
  ...
  exports.confirm = function () {
    ...
    exports.confirmSIAP = function () {
      var options;
      
      options = mergeButtons(["confirm", "cancel"], arguments, ["message", "callback"]);

      //console.log(options);
      // console.log(arguments[0].buttons);
      //delete options.buttons.confirm
      //console.log(options);

      var cliente = arguments[0].buttons;
      if (typeof cliente.confirm == "undefined")
          delete options.buttons.confirm

      if (typeof cliente.cancel == "undefined")
